---
title: "NuMA vs absense of NuMA in syncronized cells"
output:
...
params:
  ...
  descriptions_file: "./data/descriptions_02.yaml" 
---
...
The sample population include:\n
  - ", params$num_samples, " samples,", tot_conditions, " conditions, ", params$exp$description, "and", params$contr$description, " in ", params$num_replicates, " replicates each.\n", "
...
The columns in the table are:
  ...
  - log2FoldChange: The estimated log2-transformed fold change in expression between two conditions (e.g., experimental vs control). Positive values indicate upregulation, negative values indicate downregulation with respect to control.
