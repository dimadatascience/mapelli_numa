...
params:
  ...
  exp:
    value:
      condition: "NS_no_NuMA"
      description: "Non-synchronized NuMA-"
  contr:
    value:
      condition: "NS_plus_NuMA"
      description: "Non-synchronized NuMA+"
---
...
In this case the outlier sample S61878_NS_plus_NuMA_C has been removed.
...
The sample population include:\n
  - ", params$num_samples, " samples, 2 conditions, ", params$exp$description, "and", params$contr$description,".\n")
```
...
go_enrichment_A_up <- goenrichment(genelist_df_A, logfc_col = "log2FC", down = FALSE, n_genes = 100, pvalueCutoff = pvalue_cutoff_ORA, qvalueCutoff = qvalue)
go_enrichment_A_down <- goenrichment(genelist_df_A, logfc_col = "log2FC", down = TRUE, n_genes = 100, pvalueCutoff = pvalue_cutoff_ORA, qvalueCutoff = qvalue)
```
